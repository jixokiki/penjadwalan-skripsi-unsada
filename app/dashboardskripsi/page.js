...
//JANGAN DIHAPUS YA IKI INI UPDATE UDAH BENER CUMAN ADA BEBERAPA YANG HARUS DITAMBAHKAN ini update tgl 12 JULI 2025
// const handleRegister = async (e) => {
//   e.preventDefault();
//   setError(null);
//   setLoading(true);
...
const fetchUserDataByNim = async (inputId) => {
  ...
  try {
    const docRef = doc(db, "usersSkripsi", inputId);
    const docSnap = await getDoc(docRef);
    ...
    console.error("Gagal ambil data dari usersSkripsi:", error);
