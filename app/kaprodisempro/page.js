...
//JANGAN DI UBAH YA IKI UDAH BENER CODE KAPRODI SEMPRO TINGGAL BENERIN DEBUGGINGNYA SAJA
// // KaprodiPage.jsx
// "use client"
// import { useEffect, useState } from "react";
...
//       if (waktuSama) {
//         if (a.ruangan === b.ruangan) score -= 30; // bentrok ruangan
//         if (a.pembimbing === b.pembimbing) score -= 20; // pembimbing sama

//         const pengujiA = [a.penguji1, a.penguji2].filter(Boolean);
//         const pengujiB = [b.penguji1, b.penguji2].filter(Boolean);
//         const pengujiBentrok = pengujiA.some(p => pengujiB.includes(p));
//         if (pengujiBentrok) score -= 50; // bentrok penguji antar ruangan
//       }
//     }
...
// const hasBentrokPenguji = (solution) => {
...
//         const pengujiA = [a.penguji1, a.penguji2].filter(Boolean);
//         const pengujiB = [b.penguji1, b.penguji2].filter(Boolean);
//         if (pengujiA.some(p => pengujiB.includes(p))) {
//           return true;
//         }
//       }
//     }
...
//     if (hasBentrokPenguji(child)) {
//       steps.push("⚠️ Child dibuang karena bentrok penguji");
//       continue; // skip jika bentrok
//     }
